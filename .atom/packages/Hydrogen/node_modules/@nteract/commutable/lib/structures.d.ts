...
export declare const emptyCodeCell: ImmutableRecord<import("./cells").CodeCellParams> & Readonly<import("./cells").CodeCellParams>;
export declare const emptyMarkdownCell: ImmutableRecord<import("./cells").MarkdownCellParams> & Readonly<import("./cells").MarkdownCellParams>;
